...
bio: "我是方斌，一名业余摄影师。在业余时间，我喜欢用镜头记录生活和旅行中的美好瞬间。对我来说，摄影是一种排解孤独的方式。希望你能喜欢我的照片。",
  ...
  // Note: Next.js image optimization is disabled (next.config.ts: unoptimized: true).
  // All images are served directly from COS via CDN.
  // This field is kept for future reference and is not used in the codebase.
  // imageLoader: "cloudflare" | "default",
